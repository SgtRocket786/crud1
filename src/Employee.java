    ...
    public Employee(){
        ...
        saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Record Addition Unsuccessful");
                    e1.printStackTrace();
                }
        ...
        deleteButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{ pst = con.prepareStatement("delete from employee  where id = ?");
                ...
                {
                    JOptionPane.showMessageDialog(null, "Record Deletion Unsuccessfully");
                    e1.printStackTrace();
                }
            }
